<?php
// Interfaces it's a collection of abstract method and constant. class that implement Interfaces must implement all of the method and constant in that interface. Interface can't be instantiate 
